...
df = pd.read_csv(r'C:\Users\wbart\Desktop\352data\352Pricingdata.csv', index_col=0, parse_dates=True).dropna()

print(df)

(df / df.iloc[0] * 100).plot(figsize=(100, 60))
...
def neg_sharpe_ratio(weights, mean_returns, cov_matrix, risk_free_rate):
    ...
    print(-(p_ret - risk_free_rate) / p_var)
